(function() {
	...
	window.changeLanguage = function(lang) {
	    ...
	    document.querySelectorAll('[data-lang]').forEach(element => {
	        if (element.classList.contains('block-element')) {
	    ...
	    // Mostrar los elementos del idioma seleccionado
	...
	document.addEventListener('DOMContentLoaded', function() {
	    const preferredLanguage = localStorage.getItem('preferred-language') || 'ca';
	    window.changeLanguage(preferredLanguage);
	});
	...
	jQuery(function(){
	    ...
	    jQuery(document).on('click', function(e) {
	        if (!jQuery(e.target).closest('.dropdown').length && 
	            !jQuery(e.target).closest('.navbar-toggle').length) {
